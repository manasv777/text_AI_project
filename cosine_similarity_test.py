...
sim_0_3 = cosine_similarity([X[0]], [X[3]])[0][0]
print("Similarity between sentence 0 and 3:", sim_0_3)

sim_5_6 = cosine_similarity([X[5]], [X[6]])[0][0]
print("Similarity between sentence 5 and 6:", sim_5_6)

sim_0_8 = cosine_similarity([X[0]], [X[8]])[0][0]
print("Similarity between sentence 0 and 8:", sim_0_8)

sim_8_9 = cosine_similarity([X[8]], [X[9]])[0][0]
print("Similarity between sentence 8 and 9:", sim_8_9)

sim_0_12 = cosine_similarity([X[0]], [X[12]])[0][0]
print("Similarity between sentence 0 and 12:", sim_0_12)
